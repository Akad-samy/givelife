            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  <img class="profile-user-img img-responsive img-circle" src="./plugins/img/Admin.jpg" 
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="./plugins/img/Admin.jpg" alt="user image">
                        <span class='username'>
                  ...
                  <li class="pull-right"><a href="#" class="link-black text-sm">
                          <i class="fa fa-comments-o margin-r-5"></i> Comments (5)</a></li>
                      </ul>
                    ...
                    <div class="post">
                      ...
                      <div class='row margin-bottom'>
                        <div class='col-sm-6'>
                          <img class='img-responsive' src='./plugins/img/Admin.jpg' alt='Photo'>
                        </div><!-- /.col -->
                        <div class='col-sm-6'>
                          <div class='row'>
                            <div class='col-sm-6'>
                    ...
                    <ul class="timeline timeline-inverse">
                      ...
                      <li>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header no-border"><a href="#"><%=session.getAttribute("user")%></a> accepted your friend request</h3>
                        </div>
                      </li>
                      <!-- END timeline item -->
                      <!-- timeline item -->
